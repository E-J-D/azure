...
curl.exe "https://github.com/E-J-D/sdms-cloud1-azure/blob/eded9e56509c304e7216280fc5205c2545982081/Powershell/Install-Starke-DMS_setup.rex" --output C:\install\StarkeDMS-latest\setup.reg
